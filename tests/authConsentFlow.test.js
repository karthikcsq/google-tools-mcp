...
jest.unstable_mockModule('fs/promises', () => ({
    ...
    open: (...args) => {
        ...
        return Promise.resolve({
            writeFile: (...writeArgs) => { writeFileCalls.push(writeArgs); return Promise.resolve(); },
