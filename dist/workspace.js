...
// reads it back / mirrors inline pushes. Because these files hold document
// contents, the storage has to be hardened against the classic shared-/tmp
// attacks (PR #28 security review):
//
