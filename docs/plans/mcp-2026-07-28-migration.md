...
| [#2589](https://github.com/modelcontextprotocol/typescript-sdk/issues/2589) `createMcpHandler` accepts a modern POST with no `MCP-Protocol-Version` | Never route or authorize on header presence | Open |
